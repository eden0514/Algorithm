function orderOfPresentation(N, K) {
  ...
  // 이는 약 4억 8천만에 해당하며, 일반적인 수행 속도 상한(약 1억)을 훨씬 상회하므로 순열을
  // 전부 생성하는 것은 올바른 접근 방법이 아닙니다.
  ...
  for (let i = 0; i < K.length; i++) {
     ...
     * validCnt는 이렇게 됩니다. => 1
     * formerCnt는 이렇게 됩니다. => 1 * factorial(3 - 0 - 1) // i는 0부터 시작하기 때문에
     * N에서 남아 있는 수를 구할 때 - 1이 추가로 필요합니다.
     * order는 2를 추가합니다.
     * 
